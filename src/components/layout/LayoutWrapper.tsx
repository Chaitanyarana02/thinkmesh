...
export default function LayoutWrapper() {
  return (
    <div className="flex flex-col md:flex-row h-screen">
      <Sidebar />
      <main className="relative flex-1 overflow-y-auto p-6 bg-white relative overflow-hidden ">
        <div className="absolute -z-1 -left-[230px]  -top-10">
        ...
        <div className="absolute -z-1 -right-[230px]  -bottom-0">
